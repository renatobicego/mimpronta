  ...
  return (
    <main className="main pt-0 overflow-hidden">
      ...
      <Image
        ...
        width={4500}
        height={3000}
        className="absolute left-0 top-[300vh] md:top-[200vh] lg:top-[330vh] w-full object-cover h-[300vh] md:h-[200vh] lg:h-[320vh] opacity-50"
        src={"/papel.webp"}
      />
      <section className="flex w-full h-full flex-col items-center relative -mt-[5vh]">
        <div className="h-screen lg:h-[85svh] w-full max-lg:flex-col flex  lg:items-start items-center justify-center relative text-center gap-8 px-[5%] lg:px-[8.335%] pt-[15vh]">
          <Image
      ...
      <section className="w-full flex flex-col items-center relative z-20 pb-20 max-lg:pt-10">
        ...
        <Image
          ...
          alt="megafono"
          className="absolute left-0 top-10 md:-top-10 xl:top-1/3 max-w-[20%] lg:max-w-[12%] 2xl:max-w-fit"
          width={200}
          height={200}
        />
