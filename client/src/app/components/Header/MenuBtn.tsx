...
const MenuBtn = () => {
  ...
  if (open) {
    return (
      <>
        <nav
          role="navigation"
          className={`hidden lg:flex-between py-1.5 px-4 lg:pl-12 lg:pr-6 
                    border-2 border-negro rounded-2xl gap-10 font-semibold text-base
                    ${
        ...
        >
          {links.map((link, i) => {
            return (
              <li
                onClick={handleClose}
                key={i}
                className={`opacity-0 list-none ${
                  animationOpenComplete && !shrinkNav ? "animate-opacity" : ""
                }`}
              >
          ...
          <Image
            ...
            className={`opacity-0 
                        ${
                          animationOpenComplete && !shrinkNav
                            ? "animate-opacity"
                            : ""
                        } w-3 h-3 xsm:w-4 xsm:h-4 cursor-pointer mr-1`}
            width={50}
            height={50}
          />
        </nav>
  ...
  return (
    <button
      className={`flex-between py-1 px-3 xsm:py-1.5 xsm:px-4 xl:px-6 border-2 
    ...
    >
      ...
      <Image
        ...
        alt="icono menú"
        className={`w-5 h-5 xsm:w-6 xsm:h-6 opacity-0 transition-opacity  animate-opacity`}
        width={50}
        height={50}
      />
    </button>
