    ...
    <section className='w-full mt-14 sm:mt-24 lg:mt-0 flex bg-white pb-0'>
        <div className='w-[15%] sm:w-1/3 pb-8 pt-10 md:pt-20 lg:pb-0 bg-rosa 
            ...
            <Image
                ...
                width={1000}
                className=' 
                            w-full scale-[2] rotate-[30deg] sm:rotate-0 sm:w-5/6 h-auto absolute top-20 
        ...
        <div className="flex flex-col gap-4 md:gap-8 xl:gap-10 items-start justify-center w-2/3
                        mt-36 mb-20 sm:mt-44  md:mt-[18vw] 2xl:mt-[23vw] sm:mb-20 ml-6 sm:ml-0">
                ...
                {posts.map((post, i) => (
                    <SwiperSlide key={i} className='!w-5/6 !h-full sm:!w-3/4 lg:!w-[45%]'>
                        <div className='w-full flex flex-col items-start gap-2 sm:gap-4 sm:p-2 rounded-3xl'>
                            <h6 className='font-text text-base lg:text-xl 2xl:text-2xl text-justify'>{post.title}</h6>
                            <p className='line-clamp-3 text-sm lg:text-base 2xl:text-lg text-justify'>
                                {post.subtitle}
                            </p>
                            <Link href={'/blog/' + post.title} className='mt-4'>
                                <button className='border-2 border-negro px-4 sm:px-5 lg:px-6 pb-0.5 font-medium rounded-[10px] text-sm lg:text-base 2xl:text-lg'>
                                    Leer post
                                </button>
                            </Link>
                        </div>
            ...
            <Link href={'/blog'}>
                <button className="font-semibold text-negro flex items-center
