...
const Carousel = () => {
    ...
    return (
        <section ref={targetRef} className='h-[300vh] relative flex flex-col items-center w-full'>
            <div
                className="sticky top-[10vh] lg:top-[12vh] flex h-[90vh] md:h-[95vh] lg:h-screen items-center overflow-x-clip self-start w-full">
                <Image 
                    alt='fondo'
                    priority
                    width={3000}
                ...
                <motion.div 
                    ...
                    >
                        <div className= "w-[90%] sm:w-4/5 lg:w-1/2">
                            <h3 className="title-size mb-6">¿Quiénes so<span className="-scale-x-100 inline-block text-rosaOscuro">m</span>os?</h3>
                        ...
                        <p
                            ...
                            >
                                <span className="font-bold font-title">
                                    mi<span className="-scale-x-100 inline-block text-rosaOscuro">m</span>pronta 
                                </span> 
                        ...
                        <div className= "w-[90%] sm:w-4/5 lg:w-3/5 flex flex-col items-center ">
                            ...
                            A través del desarrollo de negocios con propósito 
                            o a través de la integración y visibilización  
