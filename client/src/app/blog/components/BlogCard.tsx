...
const BlogCard = ({
    ...
    return (
      <div className="w-full flex rounded-2xl border-2 border-gray-300 shadow-sm">
        ...
        <div className="flex flex-col items-start gap-1 md:gap-3 px-4 py-3 md:py-6 self-center">
          <h2 className="text-xs xsm:text-sm md:text-base lg:text-lg 2xl:text-xl  mb-2 font-medium">
            {title}
          </h2>
  ...
  return (
    <div
      className="blog-post-card flex flex-col items-start justify-end 
    ...
    >
      ...
      <Link href={"/blog/" + title} className="relative z-10">
        ...
        <p className="hidden lg:line-clamp-2 mb-4">{subtitle}</p>
